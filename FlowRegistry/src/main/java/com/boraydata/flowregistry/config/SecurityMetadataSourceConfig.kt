...
//    val data = redisService.get(RESOURCE_ROLE)
//    val roleResources: List<ResourceRole>
//    roleResources = when (data == null) {
//      true -> {
//        resourceService.setupRoleAndResource()
//      }
//      false -> {
//        JsonUtils.parseArr(data!!, ResourceRole::class.java)
//      }
//    }
//
//    if (roleResources.isNotEmpty()) {
//      roleResources.forEach {
//        val matcher = AntPathRequestMatcher(it.uri, it.method)
//        if (matcher.matches(request)) {
//          return when (it.roles.isEmpty()) {
//            true -> createList(listOf(DEFAULT_ROLE))
//            false -> createList(it.roles.map { role -> role.code!! })
//          }
//        }
//      }
//    }
